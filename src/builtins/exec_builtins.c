...
*/
static bool	setup_parent_builtin_env(t_cmd *cmd, char ***argv_ptr,
...
int	execute_parent_builtin(t_cmd *cmd, t_data_env *data)
{
	int		result;
...
int	execute_builtin(t_cmd *cmd_node, t_data_env *data, char **args)
{
	if (!args || !args[0])
		return (1);
